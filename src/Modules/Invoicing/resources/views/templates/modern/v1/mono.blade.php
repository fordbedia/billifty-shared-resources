		...
		<main class="mono-body">
			...
			<section class="mono-items-section">
				...
				<table class="mono-items{{ $hasLineDiscount ? ' has-discount' : '' }}">
					...
					<tr>
						...
						@if($hasLineDiscount)
							<th class="mono-discount-col">Discount</th>
						@endif
						...
						<tr>
							<td class="mono-desc-col">
								...
								@if(!empty($it->description))
									<div class="mono-item-description">{{ $it->description }}</div>
								@endif
							</td>
							...
							@if($hasLineDiscount)
								<td class="mono-discount-col">{{ $fmtItemLineDiscount($it) }}</td>
							@endif
			...
			<section class="mono-footer-grid">
				<div class="mono-info-box mono-payment-box">
					...
					@if($paymentTerms)
						<div class="mono-info-line"><span>Payment Terms:</span> <strong>{{ $paymentTerms }}</strong>
						</div>
					@endif
