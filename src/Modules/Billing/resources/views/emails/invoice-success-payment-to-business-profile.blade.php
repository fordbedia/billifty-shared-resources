...
<head>
    <meta charset="UTF-8">
    <title>Payment received for invoice {{ $invoice->invoice_number }}</title>
...
<div class="wrapper">
    <div class="container">
        ...
        <div class="hero">
            ...
            <h1 class="hero-title">Invoice #{{ $invoice->invoice_number }} has been paid</h1>
            <p class="hero-subtitle">
                {{ $clientName }} completed payment for this invoice.
            </p>
        ...
        <div class="content">
            <div class="body-card">
                ...
                <p>
                    Good news: <strong>{{ $clientName }}</strong> has successfully paid
                    <strong>invoice #{{ $invoice->invoice_number }}</strong>.
                    This message is a payment confirmation for your records.
                </p>
                ...
                <p>
                    Billifty has recorded this payment against the invoice so you can keep your billing
                    records up to date.
                </p>

                @if(!empty($paymentData['receipt_url'] ?? null))
                    <div class="button-wrap">
                        <a class="button" href="{{ $paymentData['receipt_url'] }}">View Stripe receipt</a>
                    </div>
                @endif
        ...
        <div class="footer">
            <p>You're receiving this message because {{ $businessName }} received an invoice payment through Billifty.</p>
