...
<head>
    <meta charset="UTF-8">
    <title>We received your message - {{ config('app.name', 'Billifty') }}</title>
...
@php
    ...
    $senderName = $contactMessage->name ?: 'there';
@endphp
<div class="wrapper">
    <div class="container">
        ...
        <div class="hero">
            ...
            <h1 class="hero-title">Thanks for contacting {{ config('app.name', 'Billifty') }}</h1>
            ...
            <div class="hero-meta">
                <div class="hero-meta-row">
                    <div class="hero-meta-item">
                        <p class="meta-label">Regarding</p>
        ...
        <div class="content">
            <div class="body-card">
                ...
                <p>
                    Thanks for reaching out to <strong>{{ config('app.name', 'Billifty') }}</strong>.
                    This email confirms that your contact request was received successfully.
                </p>

                <div class="user-message-wrapper">
                    <div class="user-message-label">Your message</div>
                ...
                <div class="details-card">
                    <h2 class="details-title">Message summary</h2>
                ...
                <p>
                    You do not need to submit another request. If we need additional details, we will reply to this email address.
                </p>

                <div class="signoff">
                    <p>
                        Best regards,<br>
                        {{ config('app.name', 'Billifty') }} Support
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="footer">
            <p>
                You’re receiving this email because you submitted a contact request to {{ config('app.name', 'Billifty') }}.
            </p>
